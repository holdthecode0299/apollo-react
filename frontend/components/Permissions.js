...
class UserPermissions extends React.Component {
    ...
    handlePermissionChange = e => {
        ...
        // create copy of current permissions 
        let updatedPermissions = [...this.state.permissions];
        // figure out to remove or add permission
        if(checkbox.checked) {
            // add it in 
            updatedPermissions.push(checkbox.value);
        } else {
            updatedPermissions = updatedPermissions.filter
            (permission => permission !== checkbpx.value );
        }
    ...
    render() {
        ...
        return (
            ...
            variables={{
                permissions: TouchList.state.permissions,
                ...
                {possiblePermissions.map(permission =>(
                    <td key={permission}>
                        ...
                        {permission}`}>
                            ...
                            type ="checkbox" 
                            checked=
                            {this.state.permissions.includes(permissions)} 
                            value={permission}
