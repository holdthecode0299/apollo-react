...
import RemoveFromCart, { ADD_TO_CART_MUTATION, REMOVE_FROM_CART_MUTATION } from '../components/RemoveFromCart'; 
...
const mocks = [
    ...
    {
        request: {query: REMOVE_FROM_CART_MUTATION, variable: { id: 'abc123'}
    },
        result: { 
        data: {
        RemoveFromCart: {
...
describe('<RemoveFromCart />', () => {
    ...
    it('removes the item from cart', async () => {
        ...
        const wrapper = mount(
            ...
            expect(res.data.me.cart[0].item.price).toBe(50000)
